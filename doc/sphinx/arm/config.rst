...
Configuration files for the DHCPv4, DHCPv6, DDNS and NETCONF modules
are defined in an extended JSON format. Basic JSON is defined in
`RFC 7159 <https://datatracker.ietf.org/doc/html/rfc7159>`__ and
`ECMA 404 <https://www.ecma-international.org/publications/standards/Ecma-404.htm>`__.
